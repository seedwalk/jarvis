...
- Example: `/jarvis-add-phase Add authentication` → description = "Add authentication"
- Example: `/jarvis-add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /jarvis-add-phase <description>
Example: /jarvis-add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /jarvis-plan-phase {N} to break down)
...
**Also available:**
- `/jarvis-add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /jarvis-insert-phase)
- Don't create plans yet (that's /jarvis-plan-phase)
