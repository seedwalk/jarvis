...
<objective>
Capture an idea, task, or issue that surfaces during a Jarvis session as a structured todo for later work.
...
- `/jarvis-add-todo Add auth token refresh` → title = "Add auth token refresh"
...
2. Add another todo
3. View all todos (/jarvis-check-todos)
```
</step>
