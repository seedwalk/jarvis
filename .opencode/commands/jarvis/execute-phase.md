...
7. **Verify phase goal**
   ...
   **Otherwise:**
   ...
   - Route by status:
     ...
     - `gaps_found` → present gaps, offer `/jarvis-plan-phase {X} --gaps`
...
- /jarvis-verify-work {Z} — manual acceptance testing before continuing
...
**Also available:**
- /jarvis-verify-work — manual acceptance testing
...
- /jarvis-verify-work {Z} — manual testing before planning

───────────────────────────────────────────────────────────────

---

After user runs /jarvis-plan-phase {Z} --gaps:
1. Planner reads VERIFICATION.md gaps
2. Creates plans 04, 05, etc. to close gaps
3. User runs /jarvis-execute-phase {Z} again
