...
**If not found:** Error - user should run `/jarvis-new-project` first.
...
<downstream_consumer>
Output consumed by /jarvis-execute-phase
...
- /jarvis-plan-phase {X} --research — re-research first
