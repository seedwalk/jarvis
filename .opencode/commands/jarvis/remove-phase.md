...
- Example: `/jarvis-remove-phase 17` → phase = 17
- Example: `/jarvis-remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /jarvis-remove-phase <phase-number>
Example: /jarvis-remove-phase 17
```
...
To abandon current work, use /jarvis-pause-work instead.
```
...
Would you like to:
- `/jarvis-progress` — see updated roadmap status
