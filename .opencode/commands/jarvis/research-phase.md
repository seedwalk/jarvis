...
description: Research how to implement a phase (standalone - usually use /jarvis-plan-phase instead)
argument-hint: "[phase]"
tools:
  - read
  - bash
...
**Note:** This is a standalone research command. For most workflows, use `/jarvis-plan-phase` which integrates research automatically.
...
<downstream_consumer>
Your RESEARCH.md will be loaded by `/jarvis-plan-phase` which uses specific sections:
