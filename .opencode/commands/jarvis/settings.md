...
description: Configure Jarvis model profiles and workflow settings
agent: gsd-settings
tools:
  - read
  - write
...
- [ ] `.planning/` is validated as an existing Jarvis project (or a clear error is shown)
...
- [ ] A clear confirmation is shown ("Jarvis ► SETTINGS UPDATED")
