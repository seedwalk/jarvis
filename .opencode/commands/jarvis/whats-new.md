---
name: jarvis-whats-new
description: See what's new in Jarvis since your installed version
---
...
- URL: `https://raw.githubusercontent.com/rokicool/jarvis-opencode/main/CHANGELOG.md`
...
**To update:** `npx jarvis-cc --global`
```
